...
namespace CuttingEdge.Logging
{
    ...
    ///     <description>
    ///         A fallback provider that the Logger class will use when logging failed on one of the
    ///         configured providers. The value must contain the name of an existing logging provider.
    ...
    public class CompositeLoggingProvider : LoggingProviderBase
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Composite logging provider");
            }
